            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>muhammadhabib9004@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Habib Saeed</span>
                    </div>
                    <div className="max-w-[510px]">
                        I am passionate MERN Stack Developer and i create and maintain modern websites and applications.
                        I am trying to solve all your business problems. Lorem Ipsum is
